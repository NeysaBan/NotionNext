...
const BLOG = {
  AUTHOR: 'NeysaBan', // 作者
  BIO: 'Hop the planets! 🛸', // 作者简介
  LINK: 'https://blog.neysaban.one', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '36234fe0580b4ab9a9f51113210ae6d7', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CUSTOM_FONT_URL: ['https://cdn.jsdelivr.net/npm/noto-serif-sc@22.0.0/noto_serif_sc_regular/css.min.css'], // 自定义字体的CSS https://cdn.jsdelivr.net/npm/lxgw-wenkai-screen-webfont@1.6.0/lxgwwenkaiscreen.css
  ...
  CONTACT_EMAIL: 'neysaunn@163.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/NeysaBan',
  CONTACT_TELEGRAM: '',
