...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '36234fe0580b4ab9a9f51113210ae6d7',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Might as well just rot around the nursery and count sheep 🐑|',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NeysaBan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hop the planets! 🛸', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.neysaban.one', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'neysaunn@163.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/NeysaBan', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  FONT_URL: [
    ...
    'https://cdn.jsdelivr.net/npm/noto-serif-sc@22.0.0/noto_serif_sc_regular/css.min.css'
  ],
  ...
  // 自定义字体的css https://cdn.jsdelivr.net/npm/noto-serif-sc@22.0.0/noto_serif_sc_regular/css.min.css
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'NeysaBan/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOHpXb9Q', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOHpXb9c4CQLke', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  COMMENT_WALINE_SERVER_URL: process.env.NEXT_PUBLIC_WALINE_SERVER_URL || 'https://walline-fuck-code.vercel.app/', // Waline 评论 @see https://waline.js.org/guide/get-started.html
